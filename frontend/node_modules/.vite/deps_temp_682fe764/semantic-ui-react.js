...
var multipleProp = function multipleProp2(possible) {
  return function(props, propName, componentName) {
    ...
    var invalid = difference_default(values, possible);
    if (invalid.length > 0) {
...
var Modal = function(_Component) {
  ...
  function Modal2() {
    ...
    _this.renderContent = function(rest) {
      var _this$props = _this.props, actions = _this$props.actions, basic = _this$props.basic, children = _this$props.children, className = _this$props.className, closeIcon = _this$props.closeIcon, content = _this$props.content, header = _this$props.header, size = _this$props.size, style = _this$props.style;
      var _this$state = _this.state, legacyStyles = _this$state.legacyStyles, scrolling = _this$state.scrolling;
      var classes = clsx_m_default("ui", size, useKeyOnly(basic, "basic"), useKeyOnly(_this.legacy, "legacy"), useKeyOnly(scrolling, "scrolling"), "modal transition visible active", className);
...
var Confirm = function(_Component) {
  ...
  _proto.render = function render() {
    var _this$props = this.props, cancelButton = _this$props.cancelButton, confirmButton = _this$props.confirmButton, content = _this$props.content, header = _this$props.header, open = _this$props.open, size = _this$props.size;
...
function getMenuOptions(config) {
  var additionLabel = config.additionLabel, additionPosition = config.additionPosition, allowAdditions = config.allowAdditions, deburr = config.deburr, multiple = config.multiple, options = config.options, search = config.search, searchQuery = config.searchQuery, value = config.value;
...
function getSelectedIndex(config) {
  var additionLabel = config.additionLabel, additionPosition = config.additionPosition, allowAdditions = config.allowAdditions, deburr = config.deburr, multiple = config.multiple, options = config.options, search = config.search, searchQuery = config.searchQuery, selectedIndex = config.selectedIndex, value = config.value;
...
function Breadcrumb(props) {
  var children = props.children, className = props.className, divider = props.divider, icon = props.icon, sections = props.sections, size = props.size;
  var classes = clsx_m_default("ui", size, "breadcrumb", className);
...
var Input = function(_Component) {
  ...
  _proto.render = function render() {
    ...
    var classes = clsx_m_default("ui", size, useKeyOnly(disabled, "disabled"), useKeyOnly(error, "error"), useKeyOnly(fluid, "fluid"), useKeyOnly(focus, "focus"), useKeyOnly(inverted, "inverted"), useKeyOnly(loading, "loading"), useKeyOnly(transparent, "transparent"), useValueAndKey(actionPosition, "action") || useKeyOnly(action, "action"), useValueAndKey(iconPosition, "icon") || useKeyOnly(icon || loading, "icon"), useValueAndKey(labelPosition, "labeled") || useKeyOnly(label, "labeled"), "input", className);
...
var Form = function(_Component) {
  ...
  _proto.render = function render() {
    var _this$props = this.props, action = _this$props.action, children = _this$props.children, className = _this$props.className, error = _this$props.error, inverted = _this$props.inverted, loading = _this$props.loading, reply = _this$props.reply, size = _this$props.size, success = _this$props.success, unstackable = _this$props.unstackable, warning2 = _this$props.warning, widths = _this$props.widths;
    var classes = clsx_m_default("ui", size, useKeyOnly(error, "error"), useKeyOnly(inverted, "inverted"), useKeyOnly(loading, "loading"), useKeyOnly(reply, "reply"), useKeyOnly(success, "success"), useKeyOnly(unstackable, "unstackable"), useKeyOnly(warning2, "warning"), useWidthProp(widths, null, true), "form", className);
...
function Loader(props) {
  var active = props.active, children = props.children, className = props.className, content = props.content, disabled = props.disabled, indeterminate = props.indeterminate, inline = props.inline, inverted = props.inverted, size = props.size;
  var classes = clsx_m_default("ui", size, useKeyOnly(active, "active"), useKeyOnly(disabled, "disabled"), useKeyOnly(indeterminate, "indeterminate"), useKeyOnly(inverted, "inverted"), useKeyOnly(children || content, "text"), useKeyOrValueAndKey(inline, "inline"), "loader", className);
...
function Rail(props) {
  var attached = props.attached, children = props.children, className = props.className, close = props.close, content = props.content, dividing = props.dividing, internal = props.internal, position = props.position, size = props.size;
  var classes = clsx_m_default("ui", position, size, useKeyOnly(attached, "attached"), useKeyOnly(dividing, "dividing"), useKeyOnly(internal, "internal"), useKeyOrValueAndKey(close, "close"), "rail", className);
...
function StepGroup(props) {
  var attached = props.attached, children = props.children, className = props.className, content = props.content, fluid = props.fluid, items = props.items, ordered = props.ordered, size = props.size, stackable = props.stackable, unstackable = props.unstackable, vertical = props.vertical, widths = props.widths;
  var classes = clsx_m_default("ui", size, useKeyOnly(fluid, "fluid"), useKeyOnly(ordered, "ordered"), useKeyOnly(unstackable, "unstackable"), useKeyOnly(vertical, "vertical"), useKeyOrValueAndKey(attached, "attached"), useValueAndKey(stackable, "stackable"), useWidthProp(widths), "steps", className);
...
var Popup = function(_Component) {
  ...
  function Popup2() {
    ...
    _this.renderContent = function(_ref) {
      ...
      var _this$props2 = _this.props, basic = _this$props2.basic, children = _this$props2.children, className = _this$props2.className, content = _this$props2.content, hideOnScroll = _this$props2.hideOnScroll, flowing = _this$props2.flowing, header = _this$props2.header, inverted = _this$props2.inverted, popper = _this$props2.popper, size = _this$props2.size, style = _this$props2.style, wide = _this$props2.wide;
...
var Progress = function(_Component) {
  ...
  _proto.render = function render() {
    var _this$props7 = this.props, active = _this$props7.active, attached = _this$props7.attached, className = _this$props7.className, color = _this$props7.color, disabled = _this$props7.disabled, error = _this$props7.error, indicating = _this$props7.indicating, inverted = _this$props7.inverted, size = _this$props7.size, success = _this$props7.success, warning2 = _this$props7.warning;
    var classes = clsx_m_default("ui", color, size, useKeyOnly(active || indicating, "active"), useKeyOnly(disabled, "disabled"), useKeyOnly(error, "error"), useKeyOnly(indicating, "indicating"), useKeyOnly(inverted, "inverted"), useKeyOnly(success || this.isAutoSuccess(), "success"), useKeyOnly(warning2, "warning"), useValueAndKey(attached, "attached"), "progress", className);
...
var Rating = function(_Component) {
  ...
  _proto.render = function render() {
    var _this2 = this;
    var _this$props2 = this.props, className = _this$props2.className, disabled = _this$props2.disabled, icon = _this$props2.icon, maxRating = _this$props2.maxRating, size = _this$props2.size;
    ...
    var classes = clsx_m_default("ui", icon, size, useKeyOnly(disabled, "disabled"), useKeyOnly(isSelecting && !disabled && selectedIndex >= 0, "selected"), "rating", className);
...
var Search = function(_Component) {
  ...
  _proto.render = function render() {
    ...
    var _this$props6 = this.props, aligned = _this$props6.aligned, category = _this$props6.category, className = _this$props6.className, fluid = _this$props6.fluid, loading = _this$props6.loading, size = _this$props6.size;
    var classes = clsx_m_default("ui", open && "active visible", size, searchClasses, useKeyOnly(category, "category"), useKeyOnly(focus, "focus"), useKeyOnly(fluid, "fluid"), useKeyOnly(loading, "loading"), useValueAndKey(aligned, "aligned"), "search", className);
...
function CommentGroup(props) {
  var className = props.className, children = props.children, collapsed = props.collapsed, content = props.content, minimal = props.minimal, size = props.size, threaded = props.threaded;
  var classes = clsx_m_default("ui", size, useKeyOnly(collapsed, "collapsed"), useKeyOnly(minimal, "minimal"), useKeyOnly(threaded, "threaded"), "comments", className);
...
// node_modules/semantic-ui-react/dist/es/views/Feed/Feed.js
function Feed(props) {
  var children = props.children, className = props.className, events = props.events, size = props.size;
  var classes = clsx_m_default("ui", size, "feed", className);
...
function StatisticGroup(props) {
  var children = props.children, className = props.className, color = props.color, content = props.content, horizontal = props.horizontal, inverted = props.inverted, items = props.items, size = props.size, widths = props.widths;
  var classes = clsx_m_default("ui", color, size, useKeyOnly(horizontal, "horizontal"), useKeyOnly(inverted, "inverted"), useWidthProp(widths), "statistics", className);
...
function Statistic(props) {
  var children = props.children, className = props.className, color = props.color, content = props.content, floated = props.floated, horizontal = props.horizontal, inverted = props.inverted, label = props.label, size = props.size, text = props.text, value = props.value;
  var classes = clsx_m_default("ui", color, size, useValueAndKey(floated, "floated"), useKeyOnly(horizontal, "horizontal"), useKeyOnly(inverted, "inverted"), "statistic", className);
